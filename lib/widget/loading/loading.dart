    ...
    return Column(
      ...
      children: [
        ...
        isCode == false
          ...
          textAlign: TextAlign.center,
          style: TextStyle(color: AppColor.borderColor, fontSize: 12.sp, fontWeight: FontWeight.w300),
        )
      ],
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          FilledButton(
            ...
            style: FilledButton.styleFrom(backgroundColor: AppColor.buttonBG),
...
class ImageError extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Icon(Icons.hide_image_outlined, size: 36.sp, color: AppColor.selectedBorderColor),
        Text('Görsel bulunamadı', style: AppTextStyle.fieldError),
        Text(str, style: AppTextStyle.fieldError),
      ],
    );
  }
}

        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              ...
              AppUI.verticalGap(),
              Text(model.title, style: AppTextStyle.ratingOverallText.copyWith(color: AppColor.white)),
              AppUI.verticalGap(0.5),
              Text(model.date.toString(), style: AppTextStyle.fieldHint.copyWith(color: AppColor.white)),
              AppUI.verticalGap(),
              Text(model.content, style: AppTextStyle.bigButtonText.copyWith(color: AppColor.white)),
              AppUI.verticalGap(2),
            ],
          ),
        ),
